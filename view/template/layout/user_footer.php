...
<!-- Push notification js -->
   <script src="<?php echo SITE_PATH; ?>view/static/asset/push.min.js"></script>
   <script src="<?php echo SITE_PATH; ?>view/static/asset/serviceWorker.min.js"></script>
...
<script type="text/javascript" src="<?php echo SITE_PATH; ?>view/static/asset/js_user/script.js"></script>
