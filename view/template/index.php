        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="video-container">
                <video src="<?php echo SITE_PATH; ?>view/static/asset/img_user/vid-1.mp4" alt="video" id="video-slider" loop autoplay muted></video>
              </div>
                <div class="headline">
                  <h1>Adventure is Worthwhile</h1>
                  <p>Discover new places with us, Adventure awaits
            ...
            <div class="swiper-slide" >
              <div class="video-container">
                <video src="<?php echo SITE_PATH; ?>view/static/asset/img_user/vid-2.mp4" id="video-slider" loop autoplay muted></video>
              </div>
                <div class="headline">
            ...
            <div class="swiper-slide">
              <div class="video-container">
                <video src="<?php echo SITE_PATH; ?>view/static/asset/img_user/vid-3.mp4" id="video-slider" loop autoplay muted></video>
              </div>
                <div class="headline">
            ...
            <div class="swiper-slide">
              <div class="video-container">
                <video src="<?php echo SITE_PATH; ?>view/static/asset/img_user/vid-4.mp4" id="video-slider" loop autoplay muted></video>
              </div>
                <div class="headline">
            ...
            <div class="swiper-slide">
              <div class="video-container">
                <video src="<?php echo SITE_PATH; ?>view/static/asset/img_user/vid-5.mp4" id="video-slider" loop autoplay muted></video>
              </div>
                <div class="headline">
...
<section class="hotels" id="hotels">
 <div class="heading text-center text-uppercase fw-bold mb-5">
    ...
    <div class="owl-carousel owl-theme">
      ...
      <div class="item">
        <div class="card mb-3">
          <img src="<?php echo SITE_PATH; ?>view/static/asset/media/places/goa.jpg" class="card-img-top">
          <div class="card-body text-start p-1">
            <span class="fw-bold">Goa</span><br>
            <small class="">310 Properties</small>
          </div>
        </div>
      </div>
      <!-- item end -->
...
<section class="review" id="review">
 ...
 <script src='https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.1.1/owl.carousel.min.js'></script><script  src="<?php echo SITE_PATH; ?>view/static/asset/js_user/script.js"></script>
  ...
  <section class="about" id="about">
    ...
    <div class="features">
      <div class="card">
        <img src="<?php echo SITE_PATH; ?>view/static/asset/img_user/t-f1.png">
        <p>Unique Stays</p>
        
      </div>
      <div class="card">
       <img src="<?php echo SITE_PATH; ?>view/static/asset/img_user/t-f2.png">
       <p>Adventure Sports</p>    
     </div> 
     <div class="card">
        <img src="<?php echo SITE_PATH; ?>view/static/asset/img_user/f3.png">
        <p>Lowest Prices</p>
      </div>
      <div class="card">
        <img src="<?php echo SITE_PATH; ?>view/static/asset/img_user/f4.png">
        <p>Verified and Safe</p>
      </div>
      <div class="card">
        <img src="<?php echo SITE_PATH; ?>view/static/asset/img_user/f5.png">
        <p>24 x 7 Support</p>
      </div>
    </div>
    </section>
